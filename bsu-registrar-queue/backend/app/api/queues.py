...
from ..models.queue import Queue, QueueCreate, QueueStatus, QueueInDB, QueueBookingSettings, QueueSettingsUpdate
...
@router.patch("/{queue_id}/settings", response_model=Queue)
